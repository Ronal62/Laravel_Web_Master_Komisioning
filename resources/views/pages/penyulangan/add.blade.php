                                ...
                                <div class="tab-content no-padding" id="myTab2Content">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-icon">
                                                        <input type="date" class="form-control" id="tgl_kom"
                                                            name="tgl_kom" value="{{ old('tgl_kom') }}" required />
                                                        @error('tgl_kom')
                                                        <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                        ...
                                                        <div class="selectgroup w-100 flex-wrap">
                                                            ...
                                                            <label class="selectgroup-item mb-2 mb-sm-0">
                                                                <input type="checkbox" name="c_rst[]"
                                                                    ...
                                                                    class="selectgroup-input"
                                                                    {{ in_array('rrctrl_on_1', old('c_rst', [])) ? 'checked' : '' }} />
                                                                <span class="selectgroup-button">OK</span>
                                                            </label>
                                                            <label class="selectgroup-item mb-2 mb-sm-0">
                                                                <input type="checkbox" name="c_rst[]"
                                                                    ...
                                                                    class="selectgroup-input"
                                                                    {{ in_array('rrctrl_on_2', old('c_rst', [])) ? 'checked' : '' }} />
                                                                <span class="selectgroup-button">NOK</span>
                                                            </label>
                                                            <label class="selectgroup-item mb-2 mb-sm-0">
                                                                <input type="checkbox" name="c_rst[]"
                                                                    ...
                                                                    class="selectgroup-input"
                                                                    {{ in_array('rrctrl_on_3', old('c_rst', [])) ? 'checked' : '' }} />
                                                                <span class="selectgroup-button">LOG</span>
                                                            </label>
                                                            <label class="selectgroup-item mb-2 mb-sm-0">
                                                                <input type="checkbox" name="c_rst[]"
                                                                    ...
                                                                    class="selectgroup-input"
                                                                    {{ in_array('rrctrl_on_4', old('c_rst', [])) ? 'checked' : '' }} />
                                                                <span class="selectgroup-button">SLD</span>
                                                            </label>
                                                            <label class="selectgroup-item mb-2 mb-sm-0">
                                                                <input type="checkbox" name="c_rst[]"
                                                                    ...
                                                                    class="selectgroup-input"
                                                                    {{ in_array('rrctrl_on_5', old('c_rst', [])) ? 'checked' : '' }} />
                                                                <span class="selectgroup-button">Tidak
                                                                    Uji</span>
                                                            </label>
                                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="v-pills-pickomisioning-nobd" role="tabpanel"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-select form-control" id="id_komkp" name="id_komkp"
                                                required>
