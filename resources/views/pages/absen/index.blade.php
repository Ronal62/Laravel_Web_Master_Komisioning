...
<script>
        ...
        var table = $('#absen-table').DataTable({
            ...
            ajax: {
                ...
                data: function(d) {
                    ...
                    d.sampai_tanggal = $('#sampai-tanggal').val();
    ...
    function exportTo(type) {
        const fromDate = document.getElementById('dari-tanggal').value;
        const toDate = document.getElementById('sampai-tanggal').value;

        if (type === 'pdf') {
            // Build URL with parameters
            let url = "{{ route('absen.exportPdf') }}?";
            const params = [];

            if (fromDate) {
                params.push('dari_tanggal=' + encodeURIComponent(fromDate));
            }
            if (toDate) {
                params.push('sampai_tanggal=' + encodeURIComponent(toDate));
            }
            ...
            alert('Excel export functionality will be implemented next!');
        }
    }
</script>
@endsection
