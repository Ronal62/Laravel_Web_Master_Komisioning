...
#keypoint-table_wrapper .dataTables_filter {
    margin-bottom: 10px;
}
</style>
@endpush
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h4 class="card-title mb-0">Data Keypoint</h4>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-2">
                            ...
                            <select id="filter-category" class="form-control">
                                ...
                                <option value="sectoral" {{ request('category') == 'sectoral' ? 'selected' : '' }}>
                                    Sectoral
                                </option>
                            </select>
                        </div>
                    ...
                    <table id="keypoint-table" class="display table table-striped table-hover" style="width:100%">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th><input type="text" placeholder="Filter Merk" class="form-control form-control-sm" />
                                </th>
                                <th><input type="text" placeholder="Filter Ket" class="form-control form-control-sm" />
                                </th>
...
$(document).ready(function() {
    console.log('=== Keypoint Page Loaded ===');
    ...
    $('#btn-export-excel').click(exportByDateExcel);
    $('#btn-export-pdf').click(exportByDatePdf);
