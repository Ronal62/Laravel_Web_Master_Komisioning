                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="ketkp" name="ketkp" rows="5"
                                                    ...
                                                    required>{{ old('ketkp', $keypoint->ketkp) }}</textarea>
                                                @error('ketkp')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                                            ...
                                                            <div class="selectgroup w-100">
                                                                ...
                                                                <label class="selectgroup-item">
                                                                    <input type="checkbox" name="{{ $field }}[]"
                                                                        ...
                                                                        {{ in_array($value, old($field, $keypoint->$field)) ? 'checked' : '' }} />
                                                                    <span
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-select form-control" id="id_picms"
                                                        ...
                                                        <option value="{{ $pic->id_picmaster }}"
                                                            {{ old('id_picms', $keypoint->id_picms) == $pic->id_picmaster ? 'selected' : '' }}>
                                                            {{ $pic->nama_picmaster }}
                                                        </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-icon">
                                                        <input type="text" class="form-control" id="pelrtu"
                                                            ...
                                                            value="{{ old('pelrtu', $keypoint->pelrtu) }}" required />
                                                        @error('pelrtu')
                                                        <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
