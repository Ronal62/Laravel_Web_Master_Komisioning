{{-- resources/views/excel/keypoint_single_excel.blade.php --}}
<!DOCTYPE html>
<html>
...
<body>
    ...
    <table>
        ...
        <tr>
            ...
            <td colspan="2" style="border: 1px solid #000000;">HAL : 1</td>
        </tr>
        {{-- Row 2 --}}
        <tr>
        ...
        @for($i = 0; $i < $maxRows; $i++) <tr>
            ...
            <td style="border: 1px solid #000000; text-align: center;">
                {{ $hardwareData[$hwItems[$i]['idx'] ?? 0]['status'] ?? '' }}
            </td>
            <td style="border: 1px solid #000000; text-align: center;">
                {{ $hardwareData[$hwItems[$i]['idx'] ?? 0]['value'] ?? '' }}
            </td>
            </tr>
            @endfor
            ...
            @for($i = 0; $i < $maxControlRows; $i++) <tr>
                ...
                <td style="border: 1px solid #000000; text-align: center;">
                    {{ $systemData[$sysItems[$i]['idx'] ?? 0]['status'] ?? '' }}
                </td>
                <td style="border: 1px solid #000000; text-align: center;">
                    {{ $systemData[$sysItems[$i]['idx'] ?? 0]['value'] ?? '' }}
                </td>
                </tr>
                @endfor
