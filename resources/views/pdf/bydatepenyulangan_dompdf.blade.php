...
<body>
    ...
    @php
    $row = $item['row'];
    $pelaksanaMs = $item['pelaksanaMs'] ?? [];
    $pelaksanaRtu = $item['pelaksanaRtu'] ?? [];
        ...
        <tr>
            ...
            <td class="col-left">
                ...
                <table class="data-table" style="margin-bottom: 4px;">
                    ...
                    <tbody>
                        @foreach($statusData as $statusIndex => $statusItem)
                        {{-- Row 1 --}}
                        <tr>
                            <td style="height: 12px; font-size: 6px; padding: 2px;">
                                {{ $statusItem['row1']['address'] ?? '' }}
                            </td>
                            <td style="height: 12px; font-size: 6px; padding: 2px;">
                                {{ $statusItem['row1']['obj'] ?? '' }}
                            </td>
                            <td rowspan="2" class="font-bold" style="font-size: 8px; padding: 2px;">
                                {{ $statusItem['name'] ?? '' }}
                            </td>
                            <td style="height: 12px; font-size: 7px; padding: 2px;">
                                {{ $statusItem['row1']['label'] ?? '' }}
                            </td>
                            <td style="height: 12px; padding: 2px;">
                                @if(in_array(1, $statusItem['row1']['checks'] ?? []))
                                <span
                                    style="font-family: DejaVu Sans; font-size: 10px; color: #16a34a; font-weight: bold;">&#10004;</span>
                                @endif
                            </td>
                            <td style="height: 12px; padding: 2px;">
                                @if(in_array(2, $statusItem['row1']['checks'] ?? []))
                                <span
                                    style="font-family: DejaVu Sans; font-size: 10px; color: #dc2626; font-weight: bold;">&#10004;</span>
                                @endif
                            </td>
                            <td style="height: 12px; padding: 2px;">
                                @if(in_array(3, $statusItem['row1']['checks'] ?? []))
                                <span
                                    style="font-family: DejaVu Sans; font-size: 10px; color: #2563eb; font-weight: bold;">&#10004;</span>
                                @endif
                            </td>
                            <td style="height: 12px; padding: 2px;">
                                @if(in_array(4, $statusItem['row1']['checks'] ?? []))
                                <span
                        ...
                        <tr>
                            <td style="height: 12px; font-size: 6px; padding: 2px;">
                                {{ $statusItem['row2']['address'] ?? '' }}
                            </td>
                            <td style="height: 12px; font-size: 6px; padding: 2px;">
                                {{ $statusItem['row2']['obj'] ?? '' }}
                            </td>
                            <td style="height: 12px; font-size: 7px; padding: 2px;">
                                {{ $statusItem['row2']['label'] ?? '' }}
                            </td>
                            <td style="height: 12px; padding: 2px;">
                                @if(in_array(1, $statusItem['row2']['checks'] ?? []))
                                <span
                                    style="font-family: DejaVu Sans; font-size: 10px; color: #16a34a; font-weight: bold;">&#10004;</span>
                                @endif
                            </td>
                            <td style="height: 12px; padding: 2px;">
                                @if(in_array(2, $statusItem['row2']['checks'] ?? []))
                                <span
                                    style="font-family: DejaVu Sans; font-size: 10px; color: #dc2626; font-weight: bold;">&#10004;</span>
                                @endif
                            </td>
                            <td style="height: 12px; padding: 2px;">
                                @if(in_array(3, $statusItem['row2']['checks'] ?? []))
                                <span
                                    style="font-family: DejaVu Sans; font-size: 10px; color: #2563eb; font-weight: bold;">&#10004;</span>
                                @endif
                            </td>
                            <td style="height: 12px; padding: 2px;">
                                @if(in_array(4, $statusItem['row2']['checks'] ?? []))
                                <span
                                    style="font-family: DejaVu Sans; font-size: 10px; color: #ea580c; font-weight: bold;">&#10004;</span>
                                @endif
                            </td>
                ...
                <table class="data-table" style="margin-bottom: 4px;">
                    ...
                    <tbody>
                        ...
                        @foreach($controlData as $ctrlItem)
                        @if(isset($ctrlItem['single']) && $ctrlItem['single'])
                        ...
                        @foreach($controlData as $ctrlIndex => $ctrlItem)
                        @if(isset($ctrlItem['single']) && $ctrlItem['single'])
                        {{-- Single Row (Reset) --}}
                        <tr>
                            <td style="height: 12px; font-size: 7px; padding: 2px;">
                                {{ $ctrlItem['row1']['address'] ?? '' }}
                            </td>
                            <td style="height: 12px; font-size: 7px; padding: 2px;">{{ $ctrlItem['row1']['obj'] ?? '' }}
                            </td>
                            <td class="font-bold" style="font-size: 8px; padding: 2px;">{{ $ctrlItem['name'] ?? '' }}
                            </td>
                            <td style="height: 12px; font-size: 7px; padding: 2px;">
                                {{ $ctrlItem['row1']['label'] ?? '' }}
                            </td>
                            <td style="height: 12px; padding: 2px;">
                                @if(in_array(1, $ctrlItem['row1']['checks'] ?? []))
                                <span
                                    style="font-family: DejaVu Sans; font-size: 10px; color: #16a34a; font-weight: bold;">&#10004;</span>
                                @endif
                            </td>
                            <td style="height: 12px; padding: 2px;">
                                @if(in_array(2, $ctrlItem['row1']['checks'] ?? []))
                                <span
                                    style="font-family: DejaVu Sans; font-size: 10px; color: #dc2626; font-weight: bold;">&#10004;</span>
                                @endif
                            </td>
                            <td style="height: 12px; padding: 2px;">
                                @if(in_array(3, $ctrlItem['row1']['checks'] ?? []))
                                <span
                                    style="font-family: DejaVu Sans; font-size: 10px; color: #2563eb; font-weight: bold;">&#10004;</span>
                                @endif
                            </td>
                            <td style="height: 12px; padding: 2px;">
                                @if(in_array(4, $ctrlItem['row1']['checks'] ?? []))
                                <span
                                    style="font-family: DejaVu Sans; font-size: 10px; color: #ea580c; font-weight: bold;">&#10004;</span>
                                @endif
                            </td>
                        ...
                        <tr>
                            <td style="height: 12px; font-size: 7px; padding: 2px;">
                                {{ $ctrlItem['row2']['address'] ?? '' }}
                            </td>
                            <td style="height: 12px; font-size: 7px; padding: 2px;">{{ $ctrlItem['row2']['obj'] ?? '' }}
                            </td>
                            <td style="height: 12px; font-size: 7px; padding: 2px;">
                                {{ $ctrlItem['row2']['label'] ?? '' }}
                            </td>
                            <td style="height: 12px; padding: 2px;">
                                @if(in_array(1, $ctrlItem['row2']['checks'] ?? []))
                                <span
                                    style="font-family: DejaVu Sans; font-size: 10px; color: #16a34a; font-weight: bold;">&#10004;</span>
                                @endif
                            </td>
                            <td style="height: 12px; padding: 2px;">
                                @if(in_array(2, $ctrlItem['row2']['checks'] ?? []))
                                <span
                                    style="font-family: DejaVu Sans; font-size: 10px; color: #dc2626; font-weight: bold;">&#10004;</span>
                                @endif
                            </td>
                            <td style="height: 12px; padding: 2px;">
                                @if(in_array(3, $ctrlItem['row2']['checks'] ?? []))
                                <span
                                    style="font-family: DejaVu Sans; font-size: 10px; color: #2563eb; font-weight: bold;">&#10004;</span>
                                @endif
                            </td>
                            <td style="height: 12px; padding: 2px;">
                                @if(in_array(4, $ctrlItem['row2']['checks'] ?? []))
                                <span
                                    style="font-family: DejaVu Sans; font-size: 10px; color: #ea580c; font-weight: bold;">&#10004;</span>
                                @endif
                            </td>
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        @endphp
                        <tr class="{{ ($meter['isPseudo'] ?? false) ? 'bg-yellow-light' : '' }}">
                            {{-- ADDRESS Column --}}
                ...
                {{-- CATATAN --}}
                <table class="border" style="margin-bottom: 4px; width: 50%;">
                    <tr>
    ...
    {{-- PAGE BREAK for next item (except last) --}}
    @if(!$loop->last)
