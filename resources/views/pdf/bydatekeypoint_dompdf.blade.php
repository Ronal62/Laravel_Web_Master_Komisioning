                            ...
                            <table style="width: 100%;">
                                <tr>
                                    ...
                                    <td width="33%" class="border-r border-b"
                                        style="height: 120px; vertical-align: bottom; text-align: center; padding-bottom: 12px;">
                                        ...
                                        <img src="data:image/png;base64,{{ $ttdData }}"
                                            style="height: 70px; width: auto; margin-bottom: 8px;">
                                        @endif
                                        ...
                                        <div style="font-size: 10px; font-weight: bold;">Field Eng. 01</div>
                                        @endif
                                    </td>
                                    ...
                                    <td width="33%" class="border-r border-b"
                                        ...
                                        <div style="font-size: 10px; font-weight: bold;">MS Eng. 01</div>
                                        @endif
                                    </td>
                                    ...
                                    <td width="34%" class="border-b"
                                        ...
                                        <div style="font-size: 10px; font-weight: bold;">Dispatcher 01</div>
                                    </td>
                                </tr>
                                <tr>
                                    {{-- Field Engineer 2 --}}
                                    <td class="border-r"
                                        ...
                                        <div style="font-size: 10px; font-weight: bold;">Field Eng. 02</div>
                                        @endif
                                    </td>
                                    ...
                                    <td class="border-r"
                                        ...
                                        <div style="font-size: 10px; font-weight: bold;">MS Eng. 02</div>
                                        @endif
                                    </td>
                                    ...
                                    <td
                                        ...
                                        <div style="font-size: 10px; font-weight: bold;">Dispatcher 02</div>
                                    </td>
                                </tr>
                            </table>
                        </td>
